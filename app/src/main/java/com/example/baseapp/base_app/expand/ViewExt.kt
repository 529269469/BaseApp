package com.example.baseapp.base_app.expand
...
import com.example.baseapp.base_app.utils.base.annotation.ShowOrientation
import com.example.baseapp.base_app.utils.base.apputils.AppManager
...
/**
 * SmartRefreshLayout是否启用刷新、加载功能
 * @receiver SmartRefreshLayout
 * @param isEnable Boolean 是否启用
 */
//fun SmartRefreshLayout.isEnableRefreshAndLoadMore(
//    isEnable: Boolean,
//    refresh: () -> Unit = {},
//    loadMore: () -> Unit = {}
//) {
...
//}
//
//fun SmartRefreshLayout.isEnableRefresh(isEnable: Boolean, refresh: () -> Unit = {}) {
//    if (isEnable) {
//        setEnableRefresh(true)
//        setEnableLoadMore(false)
//        setOnRefreshListener {
...
//}
//
//fun SmartRefreshLayout.isEnableLoadMore(isEnable: Boolean, loadMore: () -> Unit = {}) {
//    if (isEnable) {
//        setEnableRefresh(false)
//        setEnableLoadMore(true)
//        setOnLoadMoreListener {
