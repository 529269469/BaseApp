 ...
 * 简单封装一下
 */
public class CreationChartBrain {
    private LineChart chart;
    private String title;
    private List<String> dateTime = new ArrayList<>();

    public CreationChartBrain(LineChart chart,String title) {
        this.chart = chart;
        this.title = title;
    }
    ...
    public void init() {
        ...
        xl.setLabelCount(12); //分为几个
        xl.setDrawGridLines(true);
        xl.setGridColor(Color.rgb(243, 244, 246));

        xl.setDrawAxisLine(true);
//        xl.setAxisLineColor(Color.rgb(209, 213, 219)); //x线的颜色
        ...
        leftAxis.setGridColor(Color.rgb(243, 244, 246));
        leftAxis.setDrawGridLines(true);
        leftAxis.setAxisLineColor(Color.rgb(209, 213, 219));
    ...
    private LineDataSet CreateSet() {
        ...
        set.setColor(Color.rgb(152, 188, 254)); //折线颜色
